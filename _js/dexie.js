    ...
    function Dexie(dbName, options) {
        ...
        props(Table.prototype, {
            ...
            bulkPut: function(objects, keys$$1) {
                ...
                return this._idbstore(READWRITE, function(resolve, reject, idbstore) {
                    ...
                    var req, errorList = [],
                        errorHandler, numObjs = objects.length,
                        table = _this;
            ...
            bulkAdd: function(objects, keys$$1) {
                ...
                return this._idbstore(READWRITE, function(resolve, reject, idbstore, trans) {
                    ...
                    var req, errorList = [],
                        errorHandler, successHandler, numObjs = objects.length;
                    if (creatingHook !== nop) {
                        //
        ...
        function adjustToExistingIndexNames(schema, idbtrans) {
            ...
            if (/Safari/.test(navigator.userAgent) &&
                ...
                _global.WorkerGlobalScope && _global instanceof _global.WorkerGlobalScope && [].concat(navigator.userAgent.match(/Safari\/(\d*)/))[1] < 604) {
                hasGetAll = false;
            }
        }
